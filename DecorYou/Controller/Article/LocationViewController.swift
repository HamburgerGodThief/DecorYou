...
class LocationViewController: UIViewController {
    ...
    func setPicker() {
        ...
        locationPicker.layer.cornerRadius = 20
        locationPicker.layer.maskedCorners = [.layerMinXMinYCorner, .layerMaxXMinYCorner]
        locationPicker.layer.borderColor = UIColor.lightGray.cgColor
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        setPicker()
        second = second_level_area_data[0]
    }
}
...
extension LocationViewController: UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func pickerView(_ pickerView: UIPickerView, numberOfRowsInComponent component: Int) -> Int {
        ...
        case 1:
            return second.count
        default:
            return second_level_area_data[0].count
        }
    }
